...
```kotlin Kotlin
Analytics.getInstance().setCustomEvent("addtocart", "Headphones")
```
...
eventProperties.put("productId", "P450")
...
Analytics.getInstance().setCustomEvent("ProductAddedToCart", eventProps)
```
